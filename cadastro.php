...
<body>
    ...
    <main class="container">
        <form id="formCadastro" action="actions/usuario_cadastrar.php" method="POST">
            ...
            <div class="input-cadastro">
                <input type="password" name="senha_hash" id="senhaCad" placeholder="Crie uma senha" required minlength="6">
            </div>
            <div class="input-cadastro">
                <input type="password" name="confirmar_senha" id="confirmaSenhaCad" placeholder="Confirme a senha" required minlength="6">
            </div>
            <div class="options-nivellibras">
                <select name="nivel_libras">
