...
//Mensagem de erro
$err = [
    "erro_cadastro" => "Erro usuário. Tente novamente",
    "usuario_cadastro_falha" => "Erro ao cadastrar usuário. Tente novamente.",
    "usuario_sessao_invalida" => "Sessão invalida. Por favor, faça loggin novamente.",
    "usuario_login_falha" => "Email e/ou senha inválidos. Verifique suas credenciais.",
